...
hist(data$log2.fold_change.,breaks=100)   # plotting histogram of log2.fold_change for all genes
...
hist(data.sig$log2.fold_change.,breaks=100)  # plotting histogram of log2.fold_change for differentially expressed genes
...
write(data.sig.up$gene,"upregulated_genes.txt") # saving to txt file
write(data.sig.dn$gene,"downregulated_genes.txt")# saving to txt file
